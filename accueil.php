...
<div class="accueil">
    ...
    <h1 class="titre_1">Bienvenue <strong><?= $_SESSION['prenom_detenteur'];?>,</h1>


    <h3>Tu vas voir, créer des formulaires détaillés pour chacun de tes chevaux n'a jamais été aussi facile.<br>
