...
<div class="carnet_traitement">
    ...
    <a href="ajout_traitement.php?numSIRE=<?=$idSire?>" class="boutton_vertV2"><img src="ASSETS/ico/plus2.png">traitement</a>    
    <div class="carnet_traitement_affichage">
        <?php include_once('PHP/equide_functions/affichage/affichageTraitement_fct.php') ?>
    </div>
    <a href="equide_description.php?numSIRE=<?=$idSire?>" class="boutton_orangeV2"><img src="ASSETS/ico/retour.png">retour</a>
</div>
